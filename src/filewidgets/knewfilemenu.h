...
public:
...
#if KIOFILEWIDGETS_ENABLE_DEPRECATED_SINCE(5, 94)
    /**
     * Returns the files that the popup is shown for
     * @deprecated since 5.94, use KNewFileMenu::workingDirectory().
     */
    KIOFILEWIDGETS_DEPRECATED_VERSION(5, 94, "Use KNewFileMenu::workingDirectory()")
     ...
     * @deprecated since 5.94, use KNewFileMenu::setWorkingDirectory(const QUrl &).
     */
    KIOFILEWIDGETS_DEPRECATED_VERSION(5, 94, "Use KNewFileMenu::setWorkingDirectory(const QUrl &)")
...
public Q_SLOTS:
     ...
     * the New menu.
     * Requirements: call setWorkingDirectory first, and keep this KNewFileMenu instance
